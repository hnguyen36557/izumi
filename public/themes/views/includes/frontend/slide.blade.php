<div class="container">
    <div class="row">
        <div class="col-sm-12 the-slideshow slideshow-wrapper">
            <ul style="overflow: hidden;" class="slideshow">
                <li class="slide">
                    <p><a href="#"> <img src="{{ url('public/themes/assets/frontend/images/slide_1.jpg') }}" alt=""></a></p>
                ...
                <li class="slide">
                    <p><a href="#"> <img src="{{ url('public/themes/assets/frontend/images/slide_2.jpg') }}" alt=""></a></p>
                ...
                <li class="slide">
                    <p><a title="#" href="#"> <img src="{{ url('public/themes/assets/frontend/images/slide_3.jpg') }}" alt=""> </a></p>
                ...
                <li class="slide">
                    <p><a title="#" href="#"> <img src="{{ url('public/themes/assets/frontend/images/slide_4.jpg') }}" alt=""> </a></p>
                    <!-- <div class="caption light2 top-right">
                      <div class="caption-inner">
                        <p class="heading">Responsive Layout</p>
                      </div>
