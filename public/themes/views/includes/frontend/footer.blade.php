    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <div class="footer-logo"><a href="index.php" title="Logo"><img src="{{ url('public/themes/assets/frontend/images/logo.png') }}" alt="logo"></a></div>
                <address>
...
<div class="footer-bottom">
    <div class="container">
        <div class="row">
            <div class="col-sm-4 col-xs-12 coppyright"> © 2015 Magikcommerce. All Rights Reserved.</div>
