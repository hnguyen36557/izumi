...
<div class="wrapper">
	...
	<!-- Form -->
	<form class="form" id="form" action="{{ route('admin.product.store') }}"  enctype="multipart/form-data" method="post" >
		{{ csrf_field() }}
		<fieldset>
			<div class="widget">
				<div class="title">
				...
				<div class="tab_container">
					...
					<div id='tab3' class="tab_content pd0">
						<div class="formRow">
							...
							<div class="formRight">
								<textarea name="contents" id="param_content" class="editor"></textarea>
