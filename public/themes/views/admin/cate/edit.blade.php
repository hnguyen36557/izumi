...
<div class="wrapper">
	<!-- Form -->
	<form class="form" id="form" action="{{ route('admin.cate.update', $id) }}" method="post">
		{{ csrf_field() }}
		<fieldset>
			<div class="widget">
				<div class="title">
				...
				<div class="tab_container">
					...
					<div class="formRow">
						...
						<div class="formRight">
							<span class="oneTwo"><input name="name" id="param_name" _autocheck="true" type="text" value="{{ old('name', isset($cate) ? $cate->name : null) }}"/></span>
