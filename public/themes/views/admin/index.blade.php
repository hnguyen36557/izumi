...
<div class="wrapper">
    ...
    <div class="widgets">
        ...
        <div class="oneTwo">
            <div class="widget">
                <div class="title">
                    <img src="{{ url('public/themes/assets/backend/images/icons/dark/money.png') }}" class="titleIcon" />
                    <h6>Doanh số</h6>
                </div>
        ...
        <div class="oneTwo">
            <div class="widget">
                <div class="title">
                    <img src="{{ url('public/themes/assets/backend/images/icons/dark/users.png') }}" class="titleIcon" alt=""/>
        ...
        <div class="widget">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable" id="checkAll">
                ...
                <thead>
                <tr>
                    <td style="width:10px;"><img src="{{ url('public/themes/assets/backend/images/icons/tableArrows.png') }}" /></td>
